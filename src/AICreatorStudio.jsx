  ...
  const services = [
    {
      ...
      title: "AI Ad Videos",
      description:
        "Transform your brand message into captivating video ads that drive conversions and engage audiences across all platforms.",
    ...
    },
    {
      ...
      title: "AI Visuals",
      description:
        "Generate stunning, unique visuals tailored to your brand identity using cutting-edge AI technology.",
    ...
    },
    {
      ...
      description:
        "Ideate and visualize creative concepts at lightning speed with our AI-powered ideation tools.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      <nav className="relative z-10 container mx-auto px-6 py-6 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          <img src={logoD} className="rounded-3xl w-20 h-20" />
      ...
      <section className="relative z-10 container mx-auto px-6 py-20 text-center">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto">
            Transform your brand with cutting-edge AI technology. We craft
            mesmerizing ad videos and visuals that captivate audiences and drive
            results.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button
              ...
              className="border-2 border-cyan-400 text-cyan-400 px-8 py-4 rounded-full font-bold text-lg hover:bg-cyan-400 hover:text-white transition-all duration-300 transform hover:scale-105"
            >
              Get in touch
            </button>
          </div>
...
<PortfolioCarousel/>
          ...
          {[
            {
              step: "01",
              title: "Consultation",
              desc: "We understand your vision, goals, and target audience",
            },
            {
              step: "02",
              title: "AI Creation",
              desc: "Our advanced AI systems generate multiple creative options",
            },
            {
              step: "03",
              title: "Refinement",
              desc: "We perfect every detail based on your feedback",
            },
            {
              step: "04",
              title: "Delivery",
              desc: "Receive production-ready assets optimized for all platforms",
            },
          ].map((item, idx) => (
      ...
      <footer className="relative z-10 container mx-auto px-6 py-12 text-center text-gray-400 border-t border-white/10">
        <p>
          &copy; 2024 Digital Flux Media. Transforming brands with artificial
          intelligence.
        </p>
      </footer>
      <ContactForm
